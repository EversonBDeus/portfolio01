...
const activeThemeName = computed(() => {
  return themeNames[activePresetId.value] ?? 'Noir Signal'
})
...
useSeoMeta({
  ...
  description: 'Preview isolado do template premium Noir Signal'
})
</script>
          ...
          <div class="space-y-2">
            ...
            <div class="space-y-1">
              ...
              <p class="max-w-3xl text-sm leading-7 text-muted">
                Preview com hero premium, rail de sinais, spotlight de projeto,
                CTA forte de WhatsApp e contato rápido em modal.
              </p>
            </div>
          </div>
        ...
        <div class="space-y-2 text-sm text-muted">
          ...
          <div class="flex flex-wrap gap-2">
            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-noir-signal
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-noir-signal?preset=cyber-lime&amp;mode=dark
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-noir-signal?preset=ux-elite&amp;device=mobile
            </code>
          </div>
        </div>
      </footer>
