...
const previewPortfolio = computed(() => {
  return {
    ...
    settings: {
      ...
      templateId: 'noir-signal'
    }
  }
})

useSeoMeta({
  title: 'Designer Preview Noir Signal',
  description: 'Preview isolado do template Noir Signal'
})
</script>
    ...
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado do template escuro mais afiado do Lumio, com preset local,
              modo por componente e sem qualquer vazamento para o tema global.
            </p>
          </div>
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-noir-signal</code>
          <code class="designer-preview__code">/designer-preview-noir-signal?preset=minty-dark</code>
          <code class="designer-preview__code">/designer-preview-noir-signal?preset=rose-wine&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-noir-signal?preset=cyber-lime&amp;mode=light</code>
        </div>
      </footer>
    </div>
  </div>
