...
useSeoMeta({
  ...
  description: 'Preview isolado do template Imperial Arc'
})
</script>
    ...
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado do template mais curado do Lumio, com seleção de destaque,
              preset local no componente e sem depender do tema global.
            </p>
          </div>
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-imperial-arc</code>
          <code class="designer-preview__code">/designer-preview-imperial-arc?preset=rose-wine</code>
          <code class="designer-preview__code">/designer-preview-imperial-arc?preset=ux-elite&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-imperial-arc?preset=cyber-lime&amp;mode=dark</code>
        </div>
      </footer>
    </div>
  </div>
