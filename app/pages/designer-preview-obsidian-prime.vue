...
useSeoMeta({
  ...
  description: 'Preview isolado do template Obsidian Prime'
})
</script>
    ...
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado da vitrine escura premium do Lumio, com preset local,
              modo por componente e sem tocar no tema global do app.
            </p>
          </div>
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-obsidian-prime</code>
          <code class="designer-preview__code">/designer-preview-obsidian-prime?preset=ux-elite</code>
          <code class="designer-preview__code">/designer-preview-obsidian-prime?preset=rose-wine&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-obsidian-prime?preset=cyber-lime&amp;mode=light</code>
        </div>
      </footer>
    </div>
  </div>
