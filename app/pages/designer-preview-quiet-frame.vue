    ...
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado do template mais contido do Lumio, com preset local, tipografia dinâmica
              e sem tocar no tema global do sistema.
            </p>
          </div>
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-quiet-frame</code>
          <code class="designer-preview__code">/designer-preview-quiet-frame?preset=rose-wine</code>
          <code class="designer-preview__code">/designer-preview-quiet-frame?preset=ux-elite&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-quiet-frame?preset=minty-dark&amp;mode=dark</code>
        </div>
      </footer>
    </div>
  </div>
