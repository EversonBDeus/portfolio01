...
const previewPortfolio = computed(() => {
  return {
    ...
    settings: {
      ...
      templateId: 'studio-rail'
    }
  }
})

useSeoMeta({
  title: 'Designer Preview Studio Rail',
  description: 'Preview isolado do template Studio Rail'
})
</script>
  ...
  >
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado do template com coluna lateral forte, composição mais curada
              e preset 100% local no componente.
            </p>
          </div>
      ...
      <div
        ...
        :class="device === 'mobile' ? 'designer-preview__frame--mobile' : 'designer-preview__frame--desktop-wide'"
      >
        <StudioRailTemplate
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-studio-rail</code>
          <code class="designer-preview__code">/designer-preview-studio-rail?preset=rose-wine</code>
          <code class="designer-preview__code">/designer-preview-studio-rail?preset=ux-elite&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-studio-rail?preset=cyber-lime&amp;mode=light</code>
        </div>
      </footer>
    </div>
  </div>
...
.designer-preview__frame--desktop-wide {
  max-width: 82rem;
}
