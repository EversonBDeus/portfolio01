...
const activeThemeName = computed(() => {
  return themeNames[activePresetId.value] ?? 'Studio Rail'
})
...
useSeoMeta({
  ...
  description: 'Preview isolado do terceiro template Studio Rail'
})
</script>
          ...
          <div class="space-y-2">
            ...
            <div class="space-y-1">
              ...
              <p class="max-w-3xl text-sm leading-7 text-muted">
                Preview com coluna lateral forte, leitura em painéis e composição
                mais curada do que Aurora e Neon Pulse.
              </p>
            </div>
          </div>
        ...
        <div class="space-y-2 text-sm text-muted">
          ...
          <div class="flex flex-wrap gap-2">
            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-studio-rail
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-studio-rail?preset=rose-wine&amp;mode=dark
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-studio-rail?preset=ux-elite&amp;device=mobile
            </code>
          </div>
        </div>
      </footer>
