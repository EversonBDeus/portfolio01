...
const activeThemeName = computed(() => {
  return themeNames[activePresetId.value] ?? 'Still Form'
})
...
useSeoMeta({
  ...
  description: 'Preview isolado do template minimalista Still Form'
})
</script>
          ...
          <div class="space-y-2">
            ...
            <div class="space-y-1">
              ...
              <p class="max-w-3xl text-sm leading-7 text-muted">
                Preview com linguagem editorial mais silenciosa, linhas finas,
                muito respiro e visual premium sem excesso.
              </p>
            </div>
          </div>
        ...
        <div class="space-y-2 text-sm text-muted">
          ...
          <div class="flex flex-wrap gap-2">
            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-still-form
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-still-form?preset=rose-wine&amp;mode=dark
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-still-form?preset=ux-elite&amp;device=mobile
            </code>
          </div>
        </div>
      </footer>
