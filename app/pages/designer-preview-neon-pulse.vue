...
useSeoMeta({
  ...
  description: 'Preview isolado do template Neon Pulse'
})
</script>
    ...
    <div class="designer-preview__shell">
        ...
        <div class="designer-preview__header">
          <div class="designer-preview__copy">
            ...
            <p class="designer-preview__description">
              Preview isolado do template mais tech do Lumio, com preset local,
              modo por componente e composição modular pronta para integração futura.
            </p>
          </div>
      ...
      <footer class="designer-preview__surface designer-preview__surface--footer">
        ...
        <div class="designer-preview__codes">
          <code class="designer-preview__code">/designer-preview-neon-pulse</code>
          <code class="designer-preview__code">/designer-preview-neon-pulse?preset=neon-spectrum</code>
          <code class="designer-preview__code">/designer-preview-neon-pulse?preset=cyber-lime&amp;device=mobile</code>
          <code class="designer-preview__code">/designer-preview-neon-pulse?preset=rose-wine&amp;mode=light</code>
        </div>
      </footer>
    </div>
  </div>
