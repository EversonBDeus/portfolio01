...
const activeThemeName = computed(() => {
  return themeNames[activePresetId.value] ?? 'Velvet Stage'
})
          ...
          <div class="space-y-2">
            ...
            <div class="space-y-1">
              ...
              <p class="max-w-3xl text-sm leading-7 text-muted">
                Preview do template com proposta de landing premium, hero dominante
                e apresentação mais vendável do que Aurora, Neon Pulse e Studio Rail.
              </p>
            </div>
          </div>
        ...
        <div class="space-y-2 text-sm text-muted">
          ...
          <div class="flex flex-wrap gap-2">
            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-velvet-stage
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-velvet-stage?preset=rose-wine&amp;mode=dark
            </code>

            <code class="rounded-lg bg-black/5 px-2 py-1 dark:bg-white/10">
              /designer-preview-velvet-stage?preset=ux-elite&amp;device=mobile
            </code>
          </div>
        </div>
      </footer>
